function cjMatrix_word = generate_cjMatrix_Word()
...
% prepare strCells
% prepare
strCells_Words = {'ÂÌ'; 'ºì'; 'À¶'};   % lv == 1 vs. ho == 2 vs. la == 3
...
while 1
    ...
    arr_CorrectResponse_24 = arr_Word_24;
...
% output the cjMatrix_word
cjMatrix_word = matrix_24_5cols_r;
end